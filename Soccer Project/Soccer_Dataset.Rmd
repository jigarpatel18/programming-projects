...
```
This shows us that 89.5% (R-squared value) of the predictor variables
show the difference in elo_ratings. Using Poland's 1982 world cup pre-season stats, we can see if the model
